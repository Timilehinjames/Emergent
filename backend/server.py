...
async def seed_database():
    ...
    if report_count == 0:
        sample_reports = [
            {"report_id": "rpt_s1", "product_id": "prod_rice_5kg", "product_name": "Curepe Long Grain Rice 5kg", "store_name": "Massy Stores - Trincity", "price": 89.99, "quantity": 5, "unit": "kg", "unit_price": 18.00, "reporter_user_id": "system", "reporter_name": "Dotish Prices TT", "verified": True, "photo_base64": "", "created_at": datetime.now(timezone.utc).isoformat()},
            {"report_id": "rpt_s2", "product_id": "prod_rice_5kg", "product_name": "Curepe Long Grain Rice 5kg", "store_name": "PriceSmart - Chaguanas", "price": 79.99, "quantity": 5, "unit": "kg", "unit_price": 16.00, "reporter_user_id": "system", "reporter_name": "Dotish Prices TT", "verified": True, "photo_base64": "", "created_at": datetime.now(timezone.utc).isoformat()},
            {"report_id": "rpt_s3", "product_id": "prod_rice_2kg", "product_name": "Curepe Long Grain Rice 2kg", "store_name": "Hi-Lo - Maraval", "price": 42.99, "quantity": 2, "unit": "kg", "unit_price": 21.50, "reporter_user_id": "system", "reporter_name": "Dotish Prices TT", "verified": True, "photo_base64": "", "created_at": datetime.now(timezone.utc).isoformat()},
            {"report_id": "rpt_s4", "product_id": "prod_oil_5L", "product_name": "Coconut Oil 5L", "store_name": "PriceSmart - Chaguanas", "price": 145.00, "quantity": 5, "unit": "L", "unit_price": 29.00, "reporter_user_id": "system", "reporter_name": "Dotish Prices TT", "verified": True, "photo_base64": "", "created_at": datetime.now(timezone.utc).isoformat()},
            {"report_id": "rpt_s5", "product_id": "prod_oil_1L", "product_name": "Coconut Oil 1L", "store_name": "Massy Stores - Gulf City", "price": 39.99, "quantity": 1, "unit": "L", "unit_price": 39.99, "reporter_user_id": "system", "reporter_name": "Dotish Prices TT", "verified": True, "photo_base64": "", "created_at": datetime.now(timezone.utc).isoformat()},
            {"report_id": "rpt_s6", "product_id": "prod_tissue_12", "product_name": "Toilet Tissue 12-Pack", "store_name": "Pennywise - San Fernando", "price": 49.99, "quantity": 12, "unit": "roll", "unit_price": 4.17, "reporter_user_id": "system", "reporter_name": "Dotish Prices TT", "verified": True, "photo_base64": "", "created_at": datetime.now(timezone.utc).isoformat()},
            {"report_id": "rpt_s7", "product_id": "prod_tissue_4", "product_name": "Toilet Tissue 4-Pack", "store_name": "Massy Stores - Trincity", "price": 24.99, "quantity": 4, "unit": "roll", "unit_price": 6.25, "reporter_user_id": "system", "reporter_name": "Dotish Prices TT", "verified": True, "photo_base64": "", "created_at": datetime.now(timezone.utc).isoformat()},
            {"report_id": "rpt_s8", "product_id": "prod_detergent_2kg", "product_name": "Laundry Detergent 2kg", "store_name": "Pennywise - Chaguanas", "price": 34.99, "quantity": 2, "unit": "kg", "unit_price": 17.50, "reporter_user_id": "system", "reporter_name": "Dotish Prices TT", "verified": True, "photo_base64": "", "created_at": datetime.now(timezone.utc).isoformat()},
        ]
