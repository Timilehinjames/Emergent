  ...
  return (
    <ScrollView style={s.container} showsVerticalScrollIndicator={false}>
        ...
        <SafeAreaView edges={['top']}>
          <Animated.View style={[s.heroContent, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
            ...
            <View style={s.logoRow}>
              ...
              <Text style={s.logoText}>Dotish Prices TT</Text>
            </View>
      ...
      <View style={s.testimonialsSection}>
        <Text style={s.sectionLabel}>THE DOTISH PRICES TT COMMUNITY</Text>
      ...
      <View style={s.footer}>
        <View style={s.footerTop}>
          <View style={s.footerBrand}>
            ...
            <Text style={s.footerBrandText}>Dotish Prices TT</Text>
          </View>
        ...
        <Text style={s.copyright}>© 2025 Dotish Prices TT. Made with ❤️ in Trinidad & Tobago.</Text>
      </View>
    </ScrollView>
  );
}
